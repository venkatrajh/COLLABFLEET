...
export const LandingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-neutral-50 dark:bg-black text-neutral-900 dark:text-neutral-100 selection:bg-neutral-900 selection:text-white dark:selection:bg-white dark:selection:text-black">
      ...
      <header className="sticky top-0 z-50 bg-white/80 dark:bg-black/80 backdrop-blur-xl border-b border-neutral-200 dark:border-neutral-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-8 h-16 sm:h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 cursor-pointer" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
            <div className="w-9 h-9 rounded-2xl bg-black text-white dark:bg-white dark:text-black flex items-center justify-center font-black shadow-sm">
              <Truck className="w-5 h-5" />
            </div>
            <div className="flex items-center gap-1.5">
              <span className="font-extrabold text-lg tracking-tight">COLLABFLEET</span>
              <span className="px-1.5 py-0.5 text-[9px] font-black tracking-widest uppercase bg-neutral-200 dark:bg-neutral-800 rounded">
                AI
              </span>
            </div>
          </div>
          ...
          {/* Nav Links */}
          <nav className="hidden md:flex items-center gap-8 text-xs font-semibold text-neutral-600 dark:text-neutral-400">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="px-4 py-2 rounded-xl text-xs font-bold text-neutral-700 dark:text-neutral-300 hover:text-black dark:hover:text-white transition-colors"
            >
              Sign In
            </button>
            ...
            <button
              ...
              className="px-4 py-2 sm:px-5 sm:py-2.5 rounded-xl bg-black text-white dark:bg-white dark:text-black font-extrabold text-xs shadow-md hover:opacity-90 transition-all flex items-center gap-1.5"
            >
      ...
      {/* 2. HERO SECTION — LEFT-ALIGNED GRID */}
      <section className="relative pt-12 sm:pt-20 pb-20 sm:pb-28 border-b border-neutral-200 dark:border-neutral-900 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 sm:space-y-8 text-left">
              ...
              {/* Eyebrow Label */}
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-neutral-100 dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 text-[11px] font-bold text-neutral-800 dark:text-neutral-200">
              ...
              <div className="min-h-[140px] sm:min-h-[170px] flex flex-col justify-start">
                <h1 
                  key={headlineIdx} 
                  className="text-4xl sm:text-6xl md:text-7xl font-black tracking-tight leading-[1.05] whitespace-pre-line animate-text-transition text-neutral-900 dark:text-white"
                >
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 pt-2">
                <button
                  ...
                  className="px-7 py-3.5 rounded-2xl bg-black text-white dark:bg-white dark:text-black font-extrabold text-sm shadow-xl hover:opacity-90 active:scale-[0.99] transition-all flex items-center justify-center gap-2.5"
                >
                  <span>Get Started</span>
                ...
                <a
                  href="#how-it-works"
                  className="px-6 py-3.5 rounded-2xl bg-neutral-100 dark:bg-neutral-900 hover:bg-neutral-200 dark:hover:bg-neutral-800 border border-neutral-200 dark:border-neutral-800 text-neutral-900 dark:text-white font-bold text-sm transition-all flex items-center justify-center gap-2"
                >
              ...
              {/* Trust Information */}
              <div className="pt-4 border-t border-neutral-200 dark:border-neutral-800 flex flex-wrap items-center gap-6 text-xs text-neutral-500 font-medium">
                ...
                <div className="flex items-center gap-2">
                  <Check className="w-4 h-4 text-neutral-900 dark:text-white" />
                  <span>Real-Time Map Telemetry</span>
                </div>
              </div>
            ...
            <div className="lg:col-span-5 relative">
              <div className="relative rounded-3xl border border-neutral-200 dark:border-neutral-800 bg-neutral-100 dark:bg-neutral-900 p-4 shadow-2xl overflow-hidden animate-float">
                ...
                <div className="relative h-64 rounded-2xl bg-white dark:bg-neutral-950 border border-neutral-200 dark:border-neutral-800 p-4 flex flex-col justify-between overflow-hidden">
                  ...
                  <div className="relative z-10 flex items-center justify-between">
                    <div>
                      ...
                      <span className="text-sm font-black text-neutral-900 dark:text-white">Chennai Hub</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="text-[10px] font-mono text-neutral-500">346 km</span>
                      <div className="w-24 h-0.5 bg-neutral-300 dark:bg-neutral-700 relative my-1">
                        <div className="absolute -top-1.5 left-1/2 -translate-x-1/2 w-3.5 h-3.5 rounded-full bg-black dark:bg-white flex items-center justify-center text-[7px] text-white dark:text-black">
                          ▶
                        </div>
                      </div>
                      <span className="text-[9px] font-bold text-neutral-600 dark:text-neutral-400">Return Trip</span>
                    </div>
                    <div className="text-right">
                      <span className="text-[10px] uppercase font-bold text-neutral-400 block">Destination</span>
                      <span className="text-sm font-black text-neutral-900 dark:text-white">Bengaluru Inland</span>
                    </div>
                  </div>

                  {/* Live Matched Truck Badge */}
                  <div className="relative z-10 p-3 rounded-xl bg-neutral-50 dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 flex items-center justify-between">
                    <div className="flex items-center gap-2.5">
                      <div className="w-8 h-8 rounded-lg bg-black text-white dark:bg-white dark:text-black flex items-center justify-center text-xs font-black">
                        <Truck className="w-4 h-4" />
                      </div>
                      <div>
                        <div className="text-xs font-bold text-neutral-900 dark:text-white">Ashok Leyland 1618</div>
                    ...
                    <div className="text-right">
                      ...
                      <div className="text-[9px] text-neutral-500">Save ₹1,850</div>
                    </div>
                  </div>

                  {/* Metric Ribbon */}
                  <div className="relative z-10 grid grid-cols-3 gap-2 text-center pt-2 border-t border-neutral-100 dark:border-neutral-900">
                    <div>
                      <div className="text-[10px] text-neutral-400">Deadhead Saved</div>
                      <div className="text-xs font-black text-neutral-900 dark:text-white">67 km</div>
                    </div>
                    <div>
                      <div className="text-[10px] text-neutral-400">CO₂ Avoided</div>
                      <div className="text-xs font-black text-neutral-900 dark:text-white">38 kg</div>
                    </div>
                    <div>
                      <div className="text-[10px] text-neutral-400">Driver Rating</div>
                ...
                <div className="text-[10px] text-neutral-500 text-center mt-2.5">
                  Interactive real-time map available upon launching the application
                </div>
      ...
      <section id="how-it-works" className="py-20 sm:py-28 border-b border-neutral-200 dark:border-neutral-900 bg-white dark:bg-neutral-950">
        <div className="max-w-7xl mx-auto px-4 sm:px-8 text-left space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
            {[
              ...
              <div 
                key={idx}
                className="p-5 rounded-2xl bg-neutral-50 dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 space-y-3 hover:border-black dark:hover:border-white transition-colors text-left"
              >
                <span className="text-2xl font-mono font-black text-neutral-400 dark:text-neutral-600">
                  {s.step}
                </span>
                <h3 className="text-sm font-extrabold text-neutral-900 dark:text-white leading-snug">
                  {s.title}
                </h3>
      ...
      <section id="explainable-ai" className="py-20 sm:py-28 border-b border-neutral-200 dark:border-neutral-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-6 space-y-5 text-left">
              ...
              <div className="space-y-3 pt-2 text-xs text-neutral-700 dark:text-neutral-300">
            ...
            <div className="lg:col-span-6 text-left">
              <div className="p-6 sm:p-7 rounded-3xl bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 shadow-xl space-y-4">
      ...
      <section id="empty-miles" className="py-20 sm:py-28 border-b border-neutral-200 dark:border-neutral-900 bg-white dark:bg-neutral-950">
        <div className="max-w-7xl mx-auto px-4 sm:px-8 text-left space-y-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 items-center">
            ...
            <div className="p-5 rounded-2xl bg-neutral-50 dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 space-y-2">
              <span className="text-[10px] font-bold uppercase text-neutral-400 block">Stage 1</span>
              <h4 className="text-sm font-black text-neutral-900 dark:text-white">Empty Return Trip</h4>
            ...
            <div className="p-5 rounded-2xl bg-neutral-50 dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 space-y-2">
              <span className="text-[10px] font-bold uppercase text-neutral-400 block">Stage 2</span>
              <h4 className="text-sm font-black text-neutral-900 dark:text-white">AI Discovers Freight</h4>
              <p className="text-xs text-neutral-500">
            ...
            <div className="p-5 rounded-2xl bg-neutral-50 dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 space-y-2">
              <span className="text-[10px] font-bold uppercase text-neutral-400 block">Stage 3</span>
              <h4 className="text-sm font-black text-neutral-900 dark:text-white">Shared Capacity</h4>
              <p className="text-xs text-neutral-500">
                Multiple shippers or return freight seamlessly book the unutilized space.
              </p>
            </div>

            <div className="p-5 rounded-2xl bg-black text-white dark:bg-white dark:text-black border border-black dark:border-white space-y-2 shadow-lg">
              <span className="text-[10px] font-bold uppercase opacity-80 block">Outcome</span>
              <h4 className="text-sm font-black">Lower Waste & High Profit</h4>
      ...
      <section id="impact" className="py-20 sm:py-28 border-b border-neutral-200 dark:border-neutral-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-8 text-left space-y-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="p-6 rounded-3xl bg-neutral-100 dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800">
              <div className="text-3xl sm:text-5xl font-black text-neutral-900 dark:text-white tracking-tight font-mono">
                1,240 km
              </div>
      ...
      <section id="role-selection" className="py-24 sm:py-32 bg-white dark:bg-neutral-950">
        <div className="max-w-5xl mx-auto px-4 sm:px-8 text-left space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
            ...
            <div 
              ...
              className="p-8 rounded-3xl border-2 border-neutral-200 dark:border-neutral-800 hover:border-black dark:hover:border-white transition-all cursor-pointer bg-neutral-50 dark:bg-neutral-900 group shadow-sm hover:shadow-xl space-y-4"
            >
              <div className="w-12 h-12 rounded-2xl bg-black text-white dark:bg-white dark:text-black flex items-center justify-center font-bold">
                <Package className="w-6 h-6" />
              </div>
              <div>
                <h3 className="text-xl font-black text-neutral-900 dark:text-white group-hover:translate-x-1 transition-transform">
                  I need a truck
                </h3>
              ...
              <div className="pt-3 border-t border-neutral-200 dark:border-neutral-800 flex items-center justify-between text-xs font-bold text-neutral-900 dark:text-white">
